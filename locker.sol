...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    mapping(uint256 => bool) public lockTokenBlockNumber;
    struct Items {
    ...
    function setLockTokenBlockNumber(uint256 _blockNumber, bool isTrue)public {
         require(msg.sender == owner," no auth !");
         lockTokenBlockNumber[_blockNumber] = isTrue;
    }
    function setRatio(uint16 _numerator,uint16  _denominator)public {
         require(msg.sender == owner," no auth !");
    ...
    function lockTokens( uint256 _amount, uint256 _lockTokenBlockNumber) public returns (uint256 _id) {
        ...
        require(lockTokenBlockNumber[_lockTokenBlockNumber],"_lockTokenBlockNumber  is faild!");
        ...
        lpAmount = _amount.mul(numerator).div(denominator).mul(864000).div(_lockTokenBlockNumber);
